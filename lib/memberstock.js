...
module.exports = {
    ...
    createMemberStock : function(db,  request, response){
        ...
        var query = mybatisMapper.getStatement('MemberStockMapper', 'createMemberStock', param, format);
    ...
    readMemberStock : function(db,  request, response){
            ...
            //질의문 형식
            var format = {language: 'sql', indent: '  '};
            var query = mybatisMapper.getStatement('MemberStockMapper', 'readMemberStock', param, format);
            //첫번째는 xml의 name값, 두번째는 해당 xml의 id값, 세번째는 파라미터, 마지막은 포맷이다.
    ...
    deleteMemberStock : function(db,  request, response){
        ...
        //질의문 형식
        var format = {language: 'sql', indent: '  '};
        var query = mybatisMapper.getStatement('MemberStockMapper', 'deleteMemberStock', param, format);
        //첫번째는 xml의 name값, 두번째는 해당 xml의 id값, 세번째는 파라미터, 마지막은 포맷이다.
